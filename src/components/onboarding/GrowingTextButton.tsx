...
function GrowingTextButton({ open }: { open: boolean }) {
  ...
  return (
    <Button className="tablet:px-[32px] tablet:py-[16px] tablet:w-[327px] tablet:h-[60px] tablet:bg-purple-500 flex h-[56px] w-[160px] items-center rounded-[8px] bg-neutral-400 px-[24px] py-[12px] text-white">
