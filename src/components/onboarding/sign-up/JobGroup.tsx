        ...
        {category2Constants.map((category2) => {
          return (
            <button
              ...
              key={category2.kor}
              className={`${signUpData?.jobGroups === category2.enum ? 'bg-purple-400 text-white' : 'border border-neutral-400 hover:border-purple-300 hover:bg-ui-transparent-light'} text-white caption-sm-medium flex h-[36px] cursor-pointer items-center justify-center rounded-[6px] px-[12px] py-[10px]`}>
              {category2.kor}
            </button>
          )
        })}
        ...
        {category3Constants.map((category3) => {
          return (
            <button
              ...
              key={category3.kor}
              className={`${signUpData?.jobGroups === category3.enum ? 'bg-purple-400 text-white' : 'border border-neutral-400 hover:border-purple-300 hover:bg-ui-transparent-light'} text-white caption-sm-medium flex h-[36px] cursor-pointer items-center justify-center rounded-[6px] px-[12px] py-[10px]`}>
              {category3.kor}
            </button>
          )
        })}
        ...
        {category4Constants.map((category4) => {
          return (
            <button
              ...
              key={category4.kor}
              className={`${signUpData?.jobGroups === category4.enum ? 'bg-purple-400 text-white' : 'border border-neutral-400 hover:border-purple-300 hover:bg-ui-transparent-light'} text-white caption-sm-medium flex h-[36px] cursor-pointer items-center justify-center rounded-[6px] px-[12px] py-[10px]`}>
              {category4.kor}
            </button>
          )
        })}
