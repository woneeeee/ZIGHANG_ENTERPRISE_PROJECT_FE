...
export default function Experience() {
  return (
    <main
      ...
      className="flex flex-col justify-start desktop:pt-[220px] laptop:pt-[220px] tablet:pt-[220px] pt-[150px] desktop:px-8 laptop:px-8 tablet:px-8 px-4 gap-y-4 tablet:bg-[#FAFBFE] laptop:bg-[#FAFBFE] desktop:bg-[#FAFBFE] min-h-screen">
      <h1
