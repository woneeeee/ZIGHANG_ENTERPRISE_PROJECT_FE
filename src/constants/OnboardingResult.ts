...
export const ONBOARDINGRESULT: Record<CharacterKey, CharacterCopy> = {
  ...
  '풀옵션 드리머': {
    ...
    traits: {
      paragraphs: [
        '당신은 안정적 환경 속에서 효율적으로 목표를 달성하는 [[전략형 타입]]입니다. 회사에서 제공하는 복지와 시스템을 적극 활용',
        '하며, 안정적인 성취와 만족을 동시에 추구합니다.',
        '불필요한 고민보다는 계획과 자원 활용에 집중하며, [[꾸준히 자신의 커리어와 삶을 관리]]합니다. 안정성과 균형 속에서 장기적',
        '성장과 행복을 모두 놓치지 않습니다. ',
      ],
    },
  },
